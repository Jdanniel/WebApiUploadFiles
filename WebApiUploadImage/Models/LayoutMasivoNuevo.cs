...
public partial class LayoutMasivoNuevo
{
    ...
    public string TiempoEnAtender { get; set; }
    ...
    public DateTime? FechaInicioSlaInv { get; set; }
    ...
    public DateTime? FechaAlta2 { get; set; }

    public DateTime? FechaCierreSistema2 { get; set; }

    public DateTime? FechaAlpraProveedor2 { get; set; }
}
