...
public partial class BorrarReporte20222023
{
    ...
    public string TipoDeConfiguracionMit { get; set; }
    ...
    public string HorasVencidas { get; set; }

    public string VestidurasGetnet { get; set; }

    public int? SlaFijo { get; set; }

    public string NivelSla { get; set; }

    public string TelefonosEnCampo { get; set; }
    ...
    public int? RollosAInstalar { get; set; }

    public string NumSerieTerminalEntra { get; set; }

    public string NumSerieTerminalSale { get; set; }

    public string NumSerieTerminalMto { get; set; }
    ...
    public string RolloEntregados { get; set; }
    ...
    public string AtiendeEnComercio { get; set; }

    public string TidAmexCierre { get; set; }

    public string AfiliacionAmexCierre { get; set; }
    ...
    public int? FechaInicioSlaInv { get; set; }

    public int? FechaMovInventario { get; set; }

    public string NivelSlaInventario { get; set; }

    public decimal DiasSlaAdmin { get; set; }

    public decimal DiasSlaGlobal { get; set; }
    ...
    public int? IdUsuarioAltaSf { get; set; }
    ...
    public string MsiSantander { get; set; }

    public string MsiProsa { get; set; }

    public string AmexPlan { get; set; }
