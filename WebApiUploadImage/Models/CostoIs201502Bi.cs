...
public partial class CostoIs201502Bi
{
    ...
    public int IngresoAtmRegion { get; set; }

    public double? IngServModem { get; set; }

    public int IngresoModemRegion { get; set; }

    public double? IngServOtros { get; set; }

    public int IngresoOtrosRegion { get; set; }

    public double? IngServSeguridad { get; set; }

    public int IngresoSeguridadRegion { get; set; }

    public double? IngServTnm { get; set; }

    public int IngresoTnmRegion { get; set; }

    public double? IngServTpv { get; set; }

    public int IngresoTpvRegion { get; set; }

    public double? IngServ3m { get; set; }

    public int Ingreso3mRegion { get; set; }
}
