...
public partial class BdUnidadesRefaccionesAlmacen
{
    ...
    public int? IsJefeAlmacen { get; set; }

    public int? IsModeloMarca { get; set; }

    public int? IsOrdenCompra { get; set; }

    public int? IsTipoMoneda { get; set; }
}
