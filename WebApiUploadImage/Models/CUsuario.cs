...
public partial class CUsuario
{
    ...
    public int? IsCambioStatusUnidadReglaDisponibleUsuado { get; set; }

    public int? IsCambioStatusUnidadInstaladas { get; set; }

    public int? IsNotificacionInfoUsuario { get; set; }

    public int? IsReporteUnidadesApi { get; set; }

    public int? IsNotificacionLimiteUsuarios { get; set; }

    public int? IsActualizarAgregarMasivoNegocios { get; set; }
